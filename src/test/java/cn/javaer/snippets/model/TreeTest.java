...
class TreeTest {
    ...
    void of() throws Exception {
        ...
        final List<TreeNode<String>> treeNodes = Tree.of(Arrays.asList(areas1, areas2, areas3, areas4),
    ...
    @Test
    void toModel() {
        final TreeNode<String> tn1 = new TreeNode<>("河北省");
        final TreeNode<String> tn11 = new TreeNode<>("石家庄市");
        final TreeNode<String> tn2 = new TreeNode<>("山东省");
